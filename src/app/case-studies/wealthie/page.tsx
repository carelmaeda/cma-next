            ...
            {/* Research Methodology */}
              ...
              <div>
                ...
                <div className="card-wrapper three-col">
                    <div className='card'><small>What challenges do you face when trying to manage your money?</small></div>
                    <div className='card'><small>Have you ever used a financial app before? If so, what did you like or dislike about it?</small></div>
                    <div className='card'><small>If you could change one thing about how you learn or handle finances, what would it be?</small></div>
                </div>
              </div>
