...
function Wordmark() {
  return (
    <span className="inline-flex items-baseline gap-1 font-display font-semibold tracking-snug">
      Carel Maeda
      <span
        className="ml-1 h-2 w-2 -translate-y-px rounded-full bg-accentBlue"
        aria-hidden="true"
      />
    </span>
  );
